                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch ((int)drawerItem.getIdentifier()){
                            case 0:
                                startActivity(new Intent(SaltyRecipes.this,MainActivity.class));
                                break;
                            case 1:
                                startActivity(new Intent(SaltyRecipes.this,Register.class));
                                break;
                            case 2:
                                startActivity(new Intent(SaltyRecipes.this, SweetRecipes.class));
                                break;
                            case 3:
                                startActivity(new Intent(SaltyRecipes.this, SaltyRecipes.class));
                                break;
                            case 4:
                                startActivity(new Intent(SaltyRecipes.this, Search.class));
                                break;
                        }
                        return false;
                    }
